...
MODEL_REGISTRY: Dict[str, Type[nn.Module]] = {
    ...
    "d0fpn_task_tokens_film_spatial_after": TaskTokensFiLMSpatialAfterHead,
    "d0fpn_spatial_before_task_tokens_film": SpatialBeforeTaskTokensFiLMHead,
    "d0fpn_task_conditioned_spatial_attention": TaskConditionedSpatialAttentionHead,
    "d0fpn_residual_task_spatial_delta": ResidualTaskSpatialDeltaHead,
    "d0fpn_logit_residual_task_spatial": LogitResidualTaskSpatialHead,
